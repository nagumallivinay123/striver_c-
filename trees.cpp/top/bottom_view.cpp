...
#include <bits/stdc++.h>
using namespace std;
//vertical order traversal nunchi anni vastayi 
//vertical order annadi base condition 
//toop view ante vertical order lo top most element annadi untundi 
//bottom view anteh vertical order lo bootom most element annadi untundi 
//same vertical order implement chesinattu cheyali kani endhulo 
//maps ane onkoti teesukuni cheyali ,andhulo store cheyali 
//all are came from either top/bottom view
